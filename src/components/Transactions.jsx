        ...
        <div className="display-flex justify-start w-full mb-6 p-2">
          ...
          >
            <p className="text-white text-base">
              From: {formatAddress(addressFrom)}
            </p>
          </a>
          <a
...
export function Transactions() {
  const { account, allTransactions } = useContext(TransactionContext);
  return (
    <div className="flex flex-col w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
      ...
      <div className=" flex flex-row flex-wrap">
        {allTransactions.reverse().map((data, index) => {
